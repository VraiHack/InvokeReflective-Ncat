...
i decided it to make it easier for you (elearnsecurity students/...) by <ins>**```diff @@desiging the attack in a schematic way@@**</ins> for more clarity for the steps.

 ```diff @@desiging the attack in a schematic way@@
